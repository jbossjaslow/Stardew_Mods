...
namespace EmbeddedDebugger {
	/// <summary>A textbox fires events while searching. Borrowed from Pathoschild's LookupAnything mod</summary>
	internal class SearchTextBox : IDisposable {
        ...
        *********/
		...
		private static Texture2D TextboxTexture => Game1.content.Load<Texture2D>("LooseSprites\\textBox");
        ...
        *********/
		...
		public SearchTextBox(SpriteFont font, Color textColor) {
			this.Textbox = new TextBox(TextboxTexture, null, font, textColor);
